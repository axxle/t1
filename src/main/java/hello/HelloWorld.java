...
public class HelloWorld extends JFrame { //Наследуя от JFrame мы получаем всю функциональность окна
  ...
  public static void main(String[] args) { //эта функция может быть и в другом классе
    HelloWorld app = new HelloWorld(); //Создаем экземпляр нашего приложения
